        ...
        <div className="App-header">
            {
                ...
                ? (<div className="flex flex-col items-center">
                        ...
                        {/*** Spinner ***/}
                        <svg role="status" class="mr-2 w-36 h-36 text-gray-200 animate-spin dark:text-gray-200 fill-green-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
