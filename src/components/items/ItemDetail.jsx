...
const ItemDetail = ({item}) => {
    ...
    return (
        <div className="">
            ...
            <button onClick={()=>{history(-1); window.scrollTo(0,0)}}  className="animate-bounce mt-2 text-white text-shadow-h1 text-2xl font-bold ml-4">⇠ Go Back </button>
            <div className="flex flex-col items-center w-screen lg:flex lg:flex-row lg:items-start lg:justify-evenly lg:w-screen">
                <div className="animate__animated animate__slideInLeft bg-orange-200  w-5/6 lg:w-1/2 lg:h-2/3 border border-2-solid rounded-3xl">
                ...
                <div className="animate__animated animate__slideInRight bg-orange-200 text-center flex flex-col justify-between w-5/6 mt-4 mb-4 lg:w-1/3 lg:mt-0 lg:mb-0 lg:h-full border border-2-solid rounded-3xl ">
                            ...
                            ?<div className="animate__animated animate__bounceIn flex-col  text-center w-full border border-2 rounded-b-3xl bg-amber-50 p-4">
                                            ...
                                            <div className="">
                                                <div className="relative flex justify-center  text-gray-400 hover:text-green-400">
                                                    <CartWidget cartNumber={"Go to the Check-Out"} />
                                                </div>
                                                <div className="relative flex justify-center">
                                                    ...
                                                    >
                                                        Continue shopping
                                                        <EmojiHappyIcon className="ml-2 w-8 h-8"/>
                                                    </button>
                                                </div>
                                            </div>
                            </div>
