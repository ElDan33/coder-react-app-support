        ...
        <div className={darkMode ? "App-header-dark w-full h-full items-center justify-center" : "App-header w-full h-full items-center justify-center"}>
            {
                ...
                ? (<div className="flex flex-col items-center justify-center w-screen h-screen">
                        ...
                        <svg role="status" className="mr-2 w-24 h-24 text-gray-200 animate-spin dark:text-gray-200 fill-green-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
