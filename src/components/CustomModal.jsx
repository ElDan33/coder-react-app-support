                    ...
                    
                    {
                        (wannaRemove &&
                            <div className="flex justify-around pb-4 pt-8">
                                <button onClick={removeFromCartAndSetWannaRemoveHandler} 
                                        className="bg-green-600 w-20 opacity-80 rounded-xl text-gray-300 text-shadow-h1 hover:bg-green-800"
                                >
                                    YES
                                </button>
                                <button onClick={setWannaRemoveHandler} 
                                        className="bg-red-600 w-20 opacity-80 rounded-xl text-gray-300 text-shadow-h1 hover:bg-red-800"
                                >
                                    NO
                                </button>
                            </div>)
                        ||(wannaClear &&
                            <div className="flex justify-around pb-4 pt-8">
                                <button onClick={cartClearAndSetWannaClearHandler} 
                                    className="bg-green-600 w-20 opacity-80 rounded-xl text-gray-300 text-shadow-h1 hover:bg-green-800"
                                >
                                    YES
                                </button>
                                <button onClick={setWannaClearHandler} 
                                    className="bg-red-600 w-20 opacity-80 rounded-xl text-gray-300 text-shadow-h1 hover:bg-red-800"
                                >
                                    NO
                                </button>
                        ...
                        <div className="flex justify-end">
                            <button className=" mx-4 mt-12 mb-4 w-20 py-2 text-gray-500 text-xl  border-2 border-solid hover:bg-green-600 hover:text-white rounded-xl" 
