    ...
    return (
        ...
        ? (
            <div className="fixed top-0 right-0 left-0 bottom-0 z-50 bg-gray-800 opacity-90 lg:absolute lg:w-screen lg:h-screen lg:overscroll-auto">
                <div className="animate__animated animate__fadeInDown backInDown rubberBand pulse bounce heartBeat block relative my-12 ml-24 w-2/3 h-68 p-2 bg-green-300 opacity-90 rounded-2xl font-mono lg:mx-auto lg:my-36 lg:w-1/3 ">
                    <p className="px-6 py-2 text-md w-fit rounded-xl cursor-pointer text-gray-500 hover:text-white hover:bg-green-600" onClick={()=> setShowModal(false)}>x</p>
